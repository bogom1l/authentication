...
public class AccessInterceptor implements HandlerInterceptor {
    ...
    private final String[] ROUTES = {RestApiRoutes.PROMOTE, RestApiRoutes.DEMOTE, RestApiRoutes.LOGOUT};
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object object) throws IOException {
        ...
        if (requestURI.equals(RestApiRoutes.PROMOTE) || requestURI.equals(RestApiRoutes.DEMOTE)) {
    ...
    private boolean isRouteAdminRoute(String requestURI) {
        return Arrays.asList(ROUTES).contains(requestURI);
    }
}